...
export const deleteTaskInGroupTasks = (selectedTaskGroupId, taskID) => {
  return dispatch => {
    ...
    APIServices.deleteSingleInGroupTaskData(selectedTaskGroupId, taskID)
      .then(response => {
...
export const addFileToMyTask = (file, taskId) => {
  return dispatch => {
    ...
    APIServices.addFileToMyTaskData(file, taskId)
      .then(response => {
        if (response.message == 'success') {
          dispatch({
...
export const deleteTaskInMyTasks = taskID => {
  return dispatch => {
    ...
    APIServices.deleteSingleInMyTaskData(taskID)
      .then(response => {
        if (response.message == 'success') {
          dispatch({
...
export const getAllTaskByGroup = selectedTaskGroupId => {
  return dispatch => {
    ...
    APIServices.getAllTaskByGroup(selectedTaskGroupId)
      .then(response => {
        if (response.message == 'success') {
          dispatch({
